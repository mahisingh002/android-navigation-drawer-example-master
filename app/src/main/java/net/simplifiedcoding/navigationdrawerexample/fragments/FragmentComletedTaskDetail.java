...
public class FragmentComletedTaskDetail extends Fragment implements Callback<PendingTaskDetail>, View.OnClickListener {

    private static final String TAG = FragmentComletedTaskDetail.class.getSimpleName();
    ...
    private TextView tvTitleName, countTv, assignedDateTv, assignedNameTv, subjectTv, taskCompDate, taskComponTv, tvMessageUpper,
            taskRespondby, taskRespondedon, webview_tv, taskStatus, message_chain_tv, tvAttachment, tv_viewattachment, taskPrevrespondon, tvPrevmessage, prevattachmentTv;
    private ProgressDialog pDialog;
    private String task_id, wipdata;
    String message = "";
    String status = "";
    ...
    private LinearLayout llCurrentresponse, llPreviousresponse, llTaskCompOn;
    private File file;
    ...
    public FragmentComletedTaskDetail() {
        // Required empty public constructor
    }


    public static FragmentComletedTaskDetail newInstance() {
        FragmentComletedTaskDetail fragment = new FragmentComletedTaskDetail();
    ...
    void initView(View view) {
        ...
        try {
            ...
            wipdata = getArguments().getString("WIPDATA");
        ...
        llTaskCompOn = (LinearLayout) view.findViewById(R.id.ll_taskCompOn);
        ...
        if (wipdata != null && wipdata.equals("WIPDATA")) {
            tvTitleName.setText(getString(R.string.inprogress_details));
            llTaskCompOn.setVisibility(View.GONE);
        } else {
            tvTitleName.setText("COMPLETED TASK DETAILS");
        }
...
// Starts the thread by calling the run() method in its Runnable
            ...
            case R.id.tv_viewattachment:
                ...
                intent.putExtra(Config.Webview_url, compTaskdataData.get(0).getDoc());
