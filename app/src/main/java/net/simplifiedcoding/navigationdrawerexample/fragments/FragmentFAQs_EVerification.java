...
import net.simplifiedcoding.navigationdrawerexample.adapter.AdapterFaqEverification;
...
public class FragmentFAQs_EVerification extends Fragment implements Callback<FaqModel> {

    private static final String TAG = FragmentFAQs_EVerification.class.getSimpleName();
    private OnFragmentInteractionListener mListener;
    private TextView tvTitleName;
    private RecyclerView recyclerView;
    private AdapterFaqEverification adapterFaqEverification;
    private FaqModel faqModelData;
    private ProgressDialog pDialog;

    public FragmentFAQs_EVerification() {
        // Required empty public constructor
    }


    public static FragmentFAQs_EVerification newInstance() {
        FragmentFAQs_EVerification fragment = new FragmentFAQs_EVerification();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragmentfaqs_everification, container, false);
        initView(rootView);
        return rootView;
    }
    ...
    public void onResponse(Call<FaqModel> call, Response<FaqModel> response) {
        ...
        if (faqModelData != null) {
            ...
            if (Integer.parseInt(faqModelData.getStatus()) == Constant.StatusCode.CLEANMONEY_CODE_SUCCESS) {
                ...
                adapterFaqEverification = new AdapterFaqEverification(getContext(), faqModelData, FragmentFAQs_EVerification.this);
                recyclerView.setAdapter(adapterFaqEverification);
            }
        }
    }
    ...
    public interface IFAQDATA {
        @GET(Constant.WebUrl.FAQ_Everification)
