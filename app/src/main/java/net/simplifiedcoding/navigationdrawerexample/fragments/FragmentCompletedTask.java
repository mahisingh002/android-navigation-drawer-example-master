...
public class FragmentCompletedTask extends Fragment implements Callback<NewTaskData>, AdapterNewTask.ClickListener {

    private static final String TAG = FragmentCompletedTask.class.getSimpleName();
    ...
    public static FragmentCompletedTask newInstance() {
        FragmentCompletedTask fragment = new FragmentCompletedTask();
...
//        editor = sharedpreferences.edit();
    ...
    void initView(View view) {
        ...
        task_name_tv.setText(getString(R.string.completed_task));
        LinearLayoutManager layoutManager = new LinearLayoutManager(this.getContext());
        layoutManager.setSmoothScrollbarEnabled(true);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setItemAnimator(new DefaultItemAnimator());

        tvTitleName.setText("COMPLETED TASKS");
...
//        recyclerView.setAdapter(adapterNewTask);
    ...
    private void getNewTaskServerData() {
        ...
        Call<NewTaskData> call = ifaqdata.getData("Complete", user_id);
//        Call<NewTaskData> call = ifaqdata.getData("Open", "2");
    ...
    public void onItemClick(int position, View v) {
        ...
        Fragment fragment2 = new FragmentComletedTaskDetail();
        ...
        if (newTaskData != null) {
            ...
            if (Integer.parseInt(newTaskData.getStatus()) == Constant.StatusCode.CLEANMONEY_CODE_SUCCESS) {
                if (newTaskData.getData() != null && newTaskData.getData().size() > 0) {
                    adapterNewTask = new AdapterNewTask(getContext(), newTaskData.getData(), "completed",color_value,Todo_monitering);
                    recyclerView.setAdapter(adapterNewTask);
                    adapterNewTask.setOnItemClickListener(FragmentCompletedTask.this);
                } else {
                    no_task_tv.setText(getString(R.string.no_completedtask));
