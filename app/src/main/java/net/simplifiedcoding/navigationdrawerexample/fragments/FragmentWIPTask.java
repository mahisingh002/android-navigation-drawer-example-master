...
public class FragmentWIPTask extends Fragment implements Callback<NewTaskData>, AdapterNewTask.ClickListener {

    private static final String TAG = FragmentWIPTask.class.getSimpleName();
    ...
    public FragmentWIPTask() {
        // Required empty public constructor
    }


    public static FragmentWIPTask newInstance() {
        FragmentWIPTask fragment = new FragmentWIPTask();
    ...
    void initView(View view) {
        ...
        task_name_tv.setText(getString(R.string.inprogress_task));
...
//        recyclerView.setAdapter(adapterNewTask);
    ...
    public void onItemClick(int position, View v) {
        ...
        bundle.putString("WIPDATA", "WIPDATA");
        ...
        if (newTaskData != null) {
            ...
            if (Integer.parseInt(newTaskData.getStatus()) == Constant.StatusCode.CLEANMONEY_CODE_SUCCESS) {
                if (newTaskData.getData() != null && newTaskData.getData().size() > 0) {
                    ...
                    adapterNewTask = new AdapterNewTask(getContext(), pendingTaskList, "wip",color_value,Todo_monitering);
                    adapterNewTask.setOnItemClickListener(FragmentWIPTask.this);
                    recyclerView.setAdapter(adapterNewTask);
                    adapterNewTask.setOnItemClickListener(FragmentWIPTask.this);
                } else {
                    no_task_tv.setText(getString(R.string.no_taskinprogress));
