...
public class FragmentFAQs_PMGKY extends Fragment implements Callback<FaqModel> {

    private static final String TAG = FragmentFAQs_PMGKY.class.getSimpleName();
    ...
    public FragmentFAQs_PMGKY() {
        // Required empty public constructor
    }


    public static FragmentFAQs_PMGKY newInstance() {
        FragmentFAQs_PMGKY fragment = new FragmentFAQs_PMGKY();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragmentfaqs_pmgky, container, false);
        initView(rootView);
        return rootView;
    }
