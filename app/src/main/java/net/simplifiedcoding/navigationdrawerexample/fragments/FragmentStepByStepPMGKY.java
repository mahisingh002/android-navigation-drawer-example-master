...
public class FragmentStepByStepPMGKY extends Fragment {
    ...
    public FragmentStepByStepPMGKY() {
        // Required empty public constructor
    }


    public static FragmentStepByStepPMGKY newInstance() {
        FragmentStepByStepPMGKY fragment = new FragmentStepByStepPMGKY();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_stepbystep_pmgky, container, false);
        initView(rootView);
    ...
    void initView(View view) {
        ...
        tvTitleName.setText("Step By Step PMGKY");
        ...
        progressDialog.show();
        String pdfUrl = "https://www.incometaxindiaefiling.gov.in/eFiling/Portal/StaticPDF/Form%201-PMGKY_User%20Manual.pdf";
