...
public class FragmentAssignReadyUpdateTask extends Fragment implements Callback<NewTaskData>, AdapterNewTask.ClickListener {

    private static final String TAG = FragmentAssignReadyUpdateTask.class.getSimpleName();
    ...
    public FragmentAssignReadyUpdateTask() {
        // Required empty public constructor
    }


    public static FragmentAssignReadyUpdateTask newInstance() {
        FragmentAssignReadyUpdateTask fragment = new FragmentAssignReadyUpdateTask();
    ...
    void initView(View view) {
        ...
        tvTitleName.setText(getString(R.string.task_for_review));
...
//        recyclerView.setAdapter(adapterNewTask);
    ...
    public void onItemClick(int position, View v) {
        ...
        Fragment fragment2 = new FragmentAssignReadyUpdateDetail();
        ...
        if (newTaskData != null) {
            ...
            if (Integer.parseInt(newTaskData.getStatus()) == Constant.StatusCode.CLEANMONEY_CODE_SUCCESS) {
                if (newTaskData.getData() != null && newTaskData.getData().size() > 0) {
                    ...
                    recyclerView.setAdapter(adapterNewTask);
                    adapterNewTask.setOnItemClickListener(FragmentAssignReadyUpdateTask.this);
                } else {
                    no_task_tv.setText(getString(R.string.n_taskforreview));
