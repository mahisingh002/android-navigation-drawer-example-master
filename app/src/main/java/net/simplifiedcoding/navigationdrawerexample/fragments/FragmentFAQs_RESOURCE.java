...
public class FragmentFAQs_RESOURCE extends Fragment implements Callback<FaqModel> {

    private static final String TAG = FragmentFAQs_RESOURCE.class.getSimpleName();
    ...
    public FragmentFAQs_RESOURCE() {
        // Required empty public constructor
    }


    public static FragmentFAQs_RESOURCE newInstance() {
        FragmentFAQs_RESOURCE fragment = new FragmentFAQs_RESOURCE();
    ...
    public interface IFAQDATA {
        @GET(Constant.WebUrl.FAQSRESOURCE)
